...
<form action="updateStuServlet?_stuNum=${param.stuNum}&currentPage=${param.currentPage}&menuitem=xsgl" method="post">
                ...
                <tr data-index="0" class="">
                    ...
                    <td style="width:50px;">
                        <div class="layui-table-cell "><input type="text" name="stuNum" style="height: 30px"
                                                              value="${pb.list[param.listID].stuNum}"></div>
                    </td>
                </tr>
                <tr data-index="0" class="">
                    <td style="width:50px;">
                    ...
                    <td style="width:50px;">
                        <div class="layui-table-cell "><input type="type" name="name" style="height: 30px"
                                                              value="${pb.list[param.listID].name}"></div>
                    </td>
                </tr>
                <tr data-index="0" class="">
                    <td style="width:50px;">
                    ...
                    <td style="width:50px;">
                        <div class="layui-table-cell "><input type="password" name="password" style="height: 30px"
                                                              value="${pb.list[param.listID].password}"></div>
                    </td>
                </tr>
                <tr data-index="0" class="">
                    <td style="width:50px;">
                    ...
                    <td style="width:50px;">
                        <div class="layui-table-cell ">
                            <input class="browsers" list="browsers" name="dormBuildId"
                                   value="${pb.list[param.listID].dormBuildId}">
                ...
                <tr data-index="0" class="">
                    ...
                    <td style="width:50px;">
                        <div class="layui-table-cell "><input type="text" style="height: 30px" name="dormName"
                                                              value="${pb.list[param.listID].dormName}"></div>
                    </td>
                </tr>
                <tr data-index="0" class="">
                    <td style="width:50px;">
                    ...
                    <td style="width:50px;">
                        <div class="layui-table-cell "><input type="text" style="height: 30px" name="tel"
                                                              value="${pb.list[param.listID].tel}"></div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <button type="submit" class="btn btn-primary" value="保存">提交</button>&nbsp;<button
                            ...
                            href="showStuServlet?action=showStu&judge=ad&currentPage=${param.currentPage}&menuitem=xsgl">
