...
<form action="/addDormManServlet?currentPage=${param.currentPage}&menuitem=sggl" method="post">
        ...
        <div align="center" style="margin-top: 80px;width: 700px;height: 600px">
            <table cellspacing="0" cellpadding="0" border="0" class="layui-table">
                <tr data-index="0">
                    ...
                    <td>
                        <div class="layui-table-cell "><input type="text" name="userName" style="height: 30px"></div>
                    </td>
                </tr>
                <tr data-index="0">
                    <td style="width:50px;">
                ...
                <tr data-index="0">
                    ...
                    <td>
                        <div class="layui-table-cell "><input type="password" name="repassword" style="height: 30px">
                        </div>
                    </td>
                </tr>
                <tr data-index="0">
                    ...
                    <td>
                        <div class="layui-table-cell "><input type="type" name="name" style="height: 30px"></div>
                    </td>
                </tr>
                <tr data-index="0">
                    <td style="width:50px;">
                ...
                <tr data-index="0">
                    ...
                    <td style="width:50px;">
                        <div class="layui-table-cell "><input type="text" style="height: 30px" name="dormBuildName"
                            ">
                        </div>
                    </td>
                </tr>
                ...
                <tr data-index="0">
                    <td colspan="2" align="center" style="width:50px;">
                        <div class="layui-table-cell "><a href="addByExcelServlet" style="color: black">通过Excel批量导入</a>${jsts}${jsts=null}</div>
                    </td>
                </tr>
            </table>
        </div>
